...
Begin VB.Form frmbic 
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   60
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|bics|entidad|0000|S|"
      Text            =   "Dat"
      Top             =   5640
      Width           =   800
   End
...
Private Sub Form_Load()
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from bics"
    CargaGrid
End Sub
...
Private Sub CargaGrid(Optional SQL As String)
    ...
    I = 1
        ...
        DataGrid1.Columns(I).Width = 7430
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    If Index = 0 Then
        If Not IsNumeric(txtAux(0).Text) Then
            MsgBox "Código entidad tiene que ser numérico", vbExclamation
            Exit Sub
        End If
...
Dim B As Boolean
    ...
    If Modo = 3 Then
        'Estamos insertando
         Datos = DevuelveDesdeBD("nombre", "bics", "entidad", txtAux(0).Text, "N")
         If Datos <> "" Then
