...
Begin VB.Form frmFacturasPro 
   ...
   Begin VB.Frame FrameDatosFiscales 
      ...
      Begin VB.ComboBox Combo1 
         ...
         Left            =   13200
         List            =   "frmFacturasPro.frx":0002
         Style           =   2  'Dropdown List
         TabIndex        =   94
         Tag             =   "Doc- ID|N|N|||factpro|TipoDocumentoId|||"
         Top             =   390
         Width           =   3210
      End
   ...
   Begin VB.Frame FrameFiltro 
      ...
      Begin VB.ComboBox cboFiltro 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmFacturasPro.frx":0004
         Left            =   90
         List            =   "frmFacturasPro.frx":0011
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   210
         Width           =   2235
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   30
         TabIndex        =   18
         Tag             =   "Fecha|FH|N|||factpro|fecregcontable|dd/mm/yyyy|N|"
         ToolTipText     =   "Fecha registro contable"
         Top             =   3270
         Width           =   1395
      End
      ...
      Begin VB.ComboBox Combo1 
         ...
         Height          =   360
         Index           =   0
         ItemData        =   "frmFacturasPro.frx":0058
         Left            =   7980
         List            =   "frmFacturasPro.frx":005A
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   1260
         Width           =   8850
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   10
         Left            =   13470
         Picture         =   "frmFacturasPro.frx":005C
         Top             =   3000
         Width           =   240
      End
      ...
      Begin VB.Image imgpdf 
         ...
         Index           =   0
         Left            =   14880
         Picture         =   "frmFacturasPro.frx":00E7
         Top             =   240
         Width           =   240
      End
      Begin VB.Image imgpdf 
         ...
         Index           =   1
         Left            =   15240
         Picture         =   "frmFacturasPro.frx":0AE9
         Top             =   240
         Width           =   240
      End
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   9
         Left            =   10920
         Picture         =   "frmFacturasPro.frx":14EB
         Top             =   210
         Width           =   240
      End
      Begin VB.Label Label9 
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   7
         Left            =   12270
         Picture         =   "frmFacturasPro.frx":1576
         Top             =   210
         Width           =   240
      End
      Begin VB.Image imgppal 
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   0
         Left            =   7140
         Picture         =   "frmFacturasPro.frx":1601
         Top             =   210
         Width           =   240
      End
      Begin VB.Image imgppal 
      ...
      Begin VB.Frame FrameToolAux 
         ...
         Begin MSComctlLib.Toolbar ToolbarAux 
            ...
            BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty Button5 {66833FEA-8583-11D1-B16A-00C0F0283628} 
                  Object.Visible         =   0   'False
                  Object.ToolTipText     =   "Modificar observaciones linea"
               EndProperty
            EndProperty
         End
      End
...
Dim ImporteT As Currency
    ...
    If Actualizar Then
        ...
        If Sql <> "" Then
            ...
            MsgBoxA "Tiene pagos parciales realizados. Revise tesorería", vbExclamation
            Exit Sub
        End If
    ...
    If ExisteAlgunPago(Text1(2).Text, CodmactaAnt, Text1(25).Text, FecFactuAnt, True) Then
        MsgBoxA "Hay algún efecto que ya ha sido pagado. Revise cartera de pagos.", vbExclamation
    ...
    ImporteT = ImporteFormateado(Text1(13).Text)
    If Me.Combo1(1).ListIndex = 6 Then ImporteT = ImporteT - ImporteFormateado(Text1(10).Text)  'DUA sin IVA a tesoreria
    
    If CargarPagosTemporal(Text1(5).Text, FecFactuAnt, ImporteT) Then
        ...
        Else
            ...
            If Nregs = Nregs2 Then
                ...
                End If
            Else
                MsgBoxA "No coincide el número de pagos en tesoreria. Modifíquelos en cartera.", vbExclamation
...
Dim Mens As String
    ...
    If ExisteAlgunPago(Text1(2).Text, Text1(4).Text, Text1(25).Text, FecFactuAnt, False) Then
        ...
        If B Then
            ...
            If Sql <> "" Then
                MsgBoxA "La factura tiene asientos que ya están contabilizados. Revise y modifique en su caso los siguientes asientos: " & vbCrLf & vbCrLf & Sql, vbExclamation
            End If
        End If
    Else
...
Dim I As Integer
    ...
    With Me.ToolbarAux
        ...
        If vParam.ObsrvacionesLineasFrapro Then
            .Buttons(5).Image = 19
    ...
    For I = 0 To imgppal.Count - 1
        If I <> 0 And I <> 7 And I <> 9 And I <> 10 Then imgppal(I).Picture = frmppal.imgIcoForms.ListImages(1).Picture
    Next I
    ...
    Label18.Caption = vParam.captionFraProFecRegis
    NumTabMto = 1
...
Dim B As Boolean
    ...
    Else
        If Modo = 3 Or Modo = 4 Then
            If Not vParam.SII_Periodo_DesdeLiq Then
                If Not vParam.SII_ProvDesdeFechaRecepcion Then B = True
            End If
        End If
    End If
    BloqueaTXT Text1(32), Not B
...
Dim tabla As String
    ...
    Select Case Index
       ...
       Case 1 ' lineas de facturas
            ...
            If vParam.ObsrvacionesLineasFrapro Then Sql = Sql & " , observalin"
...
Private Sub imgpdf_Click(Index As Integer)
    ...
    Else
        If txtPDF.Text = "" Then
            MsgBoxA "No tiene asiganado nigún documento", vbExclamation
            Exit Sub
        End If
...
Dim CuentaAntes As String
    ...
    Case 10
        ...
        If Text1(Indice).Enabled And Not Text1(Indice).Locked Then
            Set frmF = New frmCal
            frmF.Fecha = Now
...
Private Sub BotonModificar()
    ...
    If vParam.SIITiene Then
        ...
        Else
            If Not ComprobarPeriodo2(1, 32) Then Exit Sub
        End If
    End If
    PonerModo 4
...
'Dim Datos As String
    ...
    If vParam.SIITiene And Modo = 4 Then cad = Text1(28).BackColor
    
    'Comprobamos
    B = CompForm2(Me, 1)
    
    If vParam.SIITiene And Modo = 4 Then Text1(28).BackColor = cad: cad = ""
    ...
    If vParam.SIITiene And Modo = 4 Then
        If DBLet(Data1.Recordset!SII_ID, "N") > 0 Then
            ...
            If Text1(28).BackColor = vbSiiError Then
                'Puede cambiar las cosas. NO ha sido presentada
    ...
    If Modo = 3 Then
        ...
        If Text1(20).Text = "" Then
            Sql = " codmacta = " & DBSet(Text1(4).Text, "T")
        Else
            Sql = " nifdatos = " & DBSet(Text1(20).Text, "T")
        End If
            
        Sql = " and anofactu = year(" & DBSet(Text1(1).Text, "F") & ") and " & Sql
        Sql = "select count(*) from factpro where numserie = " & DBSet(Text1(2).Text, "T") & " and numfactu = " & DBSet(Text1(25).Text, "T") & Sql
...
Dim J As Integer
    ...
    Select Case Index
        ...
        Case 1, 23 '1 - fecha de factura
            ...
            'ENERO 2020. La fecha de registro para el SII es el nuevo campo text(32)
            If Modo <> 1 Then
                If Index = 1 Then
                    I = -1
                    If Not vParam.IvaEnFechaPago Then I = 1
                    ...
                    If vParam.SIITiene Then
                        ...
                        End If
                    End If
                    If I >= 0 Then If Not ComprobarPeriodo2(Index, CByte(I)) Then PonFoco Text1(Indice)
                Else
                    I = -1
                    If vParam.IvaEnFechaPago Then I = 1
                    If vParam.SIITiene And Modo <> 1 Then
        ...
        Case 4, 6 ' cuenta de proveedor, cuenta de retencion
                ...
                Else
                    ...
                    If InStr(1, Sql, "No existe la cuenta :") > 0 And vUsu.Nivel = 0 Then
                        'NO EXISTE LA CUENTA
        ...
        Case 26, 32 ' fecha de factura
            ...
            If Modo <> 1 And Index = 32 Then
                Correcto = True
                If vParam.SIITiene Then If Not vParam.SII_ProvDesdeFechaRecepcion Then Correcto = ComprobarPeriodo2(Index, 2)
                If Not Correcto Then
                    Text1(Index).Text = ""
                    PonFoco Text1(Index) 'SOLO SII
                Else
...
Dim SqlLog As String
    ...
    'SQL = SQL & " and FECHAENT>=" & DBSet(vParam.fechaini, "F")
    'Estaba lo de arriba. Pong esto
...
Dim Ampliacion As String
    ...
    'Si llega AQUI, y es observaciones de la linea
    If vParam.ObsrvacionesLineasFrapro Then
        If Button.Index = 5 Then
            'Si cambia observaciones
            If AdoAux(1).Recordset.EOF Then Exit Sub
            If AdoAux(1).Recordset.RecordCount < 1 Then Exit Sub
            
            'Llegados aqui bloqueamos desde form
            If Not BLOQUEADesdeFormulario2(Me, Data1, 1) Then Exit Sub
                
                NumRegElim = 0
                CadenaDesdeOtroForm = DBLet(AdoAux(1).Recordset!observalin, "T")
                frmMensajes.Opcion = 69
                frmMensajes.Show vbModal
                If NumRegElim = 1 Then
                    'Volver a generar el apunte
                    CambiaObservacionesLineaFacturaAsiento
                    CargaGrid 1, True
                End If
                Screen.MousePointer = vbDefault
                Exit Sub
    ...
    If Not ComprobarPeriodo2(23, 1) Then Exit Sub
    If Not ComprobarPeriodo2(32, 2) Then Exit Sub   'estaba el 23
            ...
            If ModoLineas = 1 Then
                ...
                If CInt(ComprobarCero(txtAux(7).Text)) <> CInt(ComprobarCero(IvaCuenta)) Then
                    If vUsu.Nivel = 0 Then
                        If MsgBox("El código de iva es distinto del de la cuenta. " & vbCrLf & " ¿ Desea modificarlo en la cuenta ? " & vbCrLf & vbCrLf, vbQuestion + vbYesNo + vbDefaultButton2) = vbYes Then
                            CambiarIva = True
                        Else
                            CambiarIva = False
                        End If
...
'    End If
    ...
    I = 0
    If Index = 1 Then
       DataGridAux(1).ToolTipText = ""
       If vParam.ObsrvacionesLineasFrapro Then
            If Modo = 2 Then
                I = 1
            Else
                If Modo = 5 And ModoLineas = 0 Then I = 1
            End If
        End If
    End If
    ...
    If I = 1 Then
        If Not Data1.Recordset.EOF Then
            If Not Me.AdoAux(1).Recordset.EOF Then
                DataGridAux(1).ToolTipText = DBLet(AdoAux(1).Recordset!observalin, "T")
            End If
        End If
    End If
End Sub
...
Dim Ampliacion As String
    ...
    If DatosOkLlin(nomframe) Then
        ...
        If vParam.ObsrvacionesLineasFrapro Then
            ...
            frmMensajes.Opcion = 69
            frmMensajes.Show vbModal
            If NumRegElim = 1 Then Ampliacion = Trim(CadenaDesdeOtroForm)
        ...
        If B And InsertarDesdeForm2(Me, 2, nomframe) Then
            ...
            Select Case NumTabMto
                Case 0, 1 ' *** els index de les llinies en grid (en o sense tab) ***
                    ...
                    'Guardo el update para despues
                    If Ampliacion <> "" Then
                        Sql = "UPDATE factpro_lineas set observalin = " & DBSet(Ampliacion, "T")
                        Sql = Sql & Replace(ObtenerWhereCab(True), "factpro", "factpro_lineas") & " and numlinea = " & txtAux(4).Text
                    End If
...
Dim B As Boolean
    ...
    If Not Rs.EOF Then
        ...
        If vParam.ObsrvacionesLineasFrapro Then ToolbarAux.Buttons(5).Enabled = ToolbarAux.Buttons(2).Enabled
...
Dim Sql As String
    ...
    If Not Rs.EOF Then
        ...
        If Text1(15).Text = "" Then Text1(15).Text = DBLet(Rs!Nommacta, "T")  'si no esta razosoci , que ponga nommacta
        ...
        If Modo = 3 Then
            ...
            If DBLet(Rs!TipoRetencion, "N") = 0 Then
                'No hacemos nada
            
            Else
                PosicionarCombo Combo1(2), CInt(Rs!TipoRetencion)
                Text1(6).Text = DBLet(Rs!ctaretencion, "T")
                Text4(6).Text = PonerNombreDeCod(Text1(6), "cuentas", "nommacta", "codmacta", "T")
                If Not IsNull(Rs!porceretencion) Then Text1(7).Text = Format(Rs!porceretencion, FormatoImporte)
            End If
        End If
...
'DesdeAñadirLineaDeTotalesIVA.  Integraciones SAGE
Private Function RecalcularTotalesFactura(DesdeAñadirLineaDeTotalesIVA As Boolean) As Boolean
Dim Sql As String
Dim SqlInsert As String
Dim SqlValues As String
Dim I As Long
...
Dim IvaModificable As Boolean
    ...
    While Not Rs.EOF
        ...
        If Combo1(1).ListIndex = 1 Or Combo1(1).ListIndex = 4 Then     'Or Combo1(1).ListIndex = 6 Then las DUA si que suman
        ...
        If Rs!aplicret = 1 Then
            ...
            If TipoRetencion = 1 Then
                If Combo1(1).ListIndex = 1 Or Combo1(1).ListIndex = 4 Or Combo1(1).ListIndex = 6 Then
    ...
    If Text1(32).Text <> "" Then Sql = Sql & ", fecregcontable = '" & Format(Text1(32).Text, FormatoFecha) & " " & Format(Now, "hh:mm:ss") & "'"
        ...
        If AlgunAsientoActualizado Then
            ...
            If Not IsNull(Data1.Recordset!FechaEnt) Then
                If Format(Data1.Recordset!FechaEnt) <> Text1(1).Text Then
                    C2 = ", fecregcontable = fecregcontable"
                    C2 = "UPDATE factpro set fechaent=" & DBSet(Text1(1).Text, "F") & C2 & " "
                    Ejecuta C2 & ObtenerWhereCab(True), False
...
On Error GoTo eModificaDesdeFormAux
    ...
    If Ampliacion <> "" Then
        C2 = Trim(Mid(Ampliacion, 1, 10))
        C = Trim(Mid(Ampliacion, 11, 10))
        
        
        
        C = "UPDATE factpro SET cuereten = " & DBSet(C, "T", "S")
        If C2 <> "" Then C = C & ", codmacta =" & DBSet(C2, "T")
        Ampliacion = Trim(Mid(Ampliacion, 21))
        C = C & " , observa = " & DBSet(Ampliacion, "T", "S")
        C = C & " ,fecregcontable=fecregcontable"
...
Private Sub CambiaObservacionesLineaFacturaAsiento()
    NumDiario = 0
    ContabilizaApunte = True
    
    Sql = "UPDATE factpro_lineas set observalin = " & DBSet(CadenaDesdeOtroForm, "T")
    Sql = Sql & Replace(ObtenerWhereCab(True), "factpro", "factpro_lineas") & " and numlinea = " & DBLet(AdoAux(1).Recordset!NumLinea, "N")
    If Not Ejecuta(Sql, False) Then Exit Sub
    ...
    'Lo vueleve a generar el apunte
    If Not IntegrarFactura_(False) Then
        TerminaBloquear
        Exit Sub
    End If
