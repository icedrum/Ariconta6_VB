...
Begin VB.Form frmFacturasPro 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image imgpdf 
         ...
         Index           =   1
         Left            =   15240
         Picture         =   "frmFacturasPro.frx":68AA
         Top             =   240
         Width           =   240
      End
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   9
         Left            =   10920
         Picture         =   "frmFacturasPro.frx":D0FC
         Top             =   210
         Width           =   240
      End
      Begin VB.Label Label9 
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   7
         Left            =   12270
         Picture         =   "frmFacturasPro.frx":D187
         Top             =   210
         Width           =   240
      End
      Begin VB.Image imgppal 
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   0
         Left            =   7620
         Picture         =   "frmFacturasPro.frx":D212
         Top             =   210
         Width           =   240
      End
      Begin VB.Image imgppal 
    ...
    If CargarPagosTemporal(Text1(5).Text, FecFactuAnt, ImporteFormateado(Text1(13).Text)) Then
        ...
        Else
            ...
            If Nregs = Nregs2 Then
                ...
                If MsgBox("¿ Desea recalcular los vencimientos ?", vbQuestion + vbYesNoCancel + vbDefaultButton1) = vbYes Then
                    CargarPagos
                End If
            Else
