...
Dim i As Currency
    ...
    If Opcion = 16 Then
        'Desde fichero NO puedo marcar ni desmarcar
        Item.Checked = Not Item.Checked
        MsgBox "No puede marcar/desmarcar ningun vencimiento", vbExclamation
        Exit Sub
...
Dim TipoFicheroDevolucion As Byte
    ...
    lwCobros.Enabled = True 'Ago2021    Dejo habilitado para poder mostrar tooltips (Opcion <> 16)
