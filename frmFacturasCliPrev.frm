...
Begin VB.Form frmFacturasCliPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   11985
   Icon            =   "frmFacturasCliPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   13
      Tag             =   "Total Factura|N|N|||factcli|totfaccl|###,###,##0.00||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   11
      Tag             =   "Cliente|T|N|||factcli|codmacta|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Fecha Factura|F|N|||factcli|fecfactu|dd/mm/yyyy|S|"
      Top             =   4920
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   1
      Tag             =   "Factura|N|N|||factcli|numfactu|0000000|S|"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Nº Serie|T|N|||factcli|numserie||S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFacturasCliPrev.frx":000C
      Height          =   5295
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmFacturasCliPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select numserie, numfactu, fecfactu, codmacta, nommacta, totfaccl from factcli where (1=1)"
...
Private Sub CargaGrid(Optional vSql As String)
    ...
    tots = "S|txtAux(0)|T|Serie|800|;S|txtAux(1)|T|Factura|1100|;S|txtAux(2)|T|Fecha|1300|;S|txtAux(3)|T|Cliente|1400|;S|txtAux(4)|T|Nombre|4200|;S|txtAux(5)|T|Total|2200|;"
