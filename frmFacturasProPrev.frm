...
Begin VB.Form frmFacturasProPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   14325
   Icon            =   "frmFacturasProPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6435
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   1
      Tag             =   "Registro|N|N|||factpro|numregis|0000000|S|"
      Top             =   4920
      Width           =   975
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Fecha Recepción|F|N|||factpro|fecharec|dd/mm/yyyy|S|"
      Top             =   4920
      Width           =   975
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   7
      Tag             =   "Total Factura|N|N|||factpro|totfacpr|###,###,##0.00||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   5
      Tag             =   "Proveedor|T|N|||factpro|codmacta|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   4
      Tag             =   "Fecha Factura|F|N|||factpro|fecfactu|dd/mm/yyyy||"
      Top             =   4920
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   3
      Tag             =   "Factura|T|N|||factpro|numfactu|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Nº Serie|T|N|||factpro|numserie||S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFacturasProPrev.frx":000C
      Height          =   5295
      Left            =   120
      TabIndex        =   12
      Top             =   360
   ...
   End
End
Attribute VB_Name = "frmFacturasProPrev"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "factpro.numserie is null "
    '*******************************************************************************
    'Buscar
    For i = 0 To txtAux.Count - 1
        txtAux(i).Text = ""
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select numserie, numregis, fecharec, numfactu, fecfactu, codmacta, nommacta, totfacpr from factpro where (1=1) "
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    '********************* canviar el ORDER BY *********************++
    If CampoOrden = "" Then
        SQL = SQL & " ORDER BY numserie, numregis, fecharec "
    Else
    ...
    tots = "S|txtAux(0)|T|Serie|800|;S|txtAux(7)|T|Registro|1100|;S|txtAux(6)|T|Fec.Recepcion|1300|;S|txtAux(1)|T|Factura|1100|;S|txtAux(2)|T|Fecha|1300|;S|txtAux(3)|T|Cliente|1400|;S|txtAux(4)|T|Nombre|4200|;S|txtAux(5)|T|Total|2200|;"
...
Dim RC As String
    ...
    If Not PerderFocoGnral(txtAux(Index), 1) Then Exit Sub
