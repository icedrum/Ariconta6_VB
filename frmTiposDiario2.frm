...
Begin VB.Form frmTiposDiario 
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   120
      TabIndex        =   0
      Tag             =   "Numero de diario|N|N|0|100|tiposdiario|numdiari|00|S|"
      Text            =   "Dat"
      Top             =   5760
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      Left            =   1260
      TabIndex        =   1
      Tag             =   "Denominación|T|N|||tiposdiario|desdiari|||"
      Text            =   "Dato2"
      Top             =   5760
      Width           =   1395
   End
...
Dim SQL As String
    SepuedeBorrar = False
    SQL = DevuelveDesdeBD("tipoamor", "paramamort", "numdiari", adodc1.Recordset!NumDiari, "N")
    If SQL <> "" Then
