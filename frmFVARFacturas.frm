    ...
    Select Case Modo
        ...
        Case 3 'INSERTAR
            If DatosOK Then
                ...
                If vParam.NumeroFacturasVariasPorAnyo Then
                    
                    B = Mc.LeerTipoDocumento(Text1(0).Text, i = 0, CDate(Text1(2).Text))
                    
                Else
                    If Mc.ConseguirContador(Text1(0).Text, (i = 0), False) = 0 Then
                        B = True
                    Else
                        B = False
                    End If
