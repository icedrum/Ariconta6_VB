VERSION 5.00
Begin VB.Form frmInmoConceptosList 
   ...
   End
End
Attribute VB_Name = "frmInmoConceptosList"
...
Private Sub cmdAccion_Click(Index As Integer)
    ...
    If Not PonerDesdeHasta("inmovcon.codconam", "CONC", Me.txtConcepto(0), Me.txtNConcepto(0), Me.txtConcepto(1), Me.txtNConcepto(1), "pDH=""") Then Exit Sub
    
    If Not HayRegParaInforme("inmovcon", cadselect) Then Exit Sub
...
Private Sub Form_Load()
    ...
    'Otras opciones
    Me.Caption = "Conceptos Inmovilizado"
...
Private Sub AccionesCSV()
    ...
    'Monto el SQL
    SQL = "Select  codconam as codigo ,nomconam as descripcion FROM inmovcon "
...
Dim nomDocu As String
    ...
    If optVarios(1).Value Then
        cadParam = cadParam & "pOrden={inmovcon.nomconam}|"
    Else
        cadParam = cadParam & "pOrden={inmovcon.codconam}|"
    End If
    numParam = numParam + 1
    ...
    cadNomRPT = nomDocu '"ConceptosInmo.rpt"
