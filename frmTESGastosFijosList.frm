VERSION 5.00
Begin VB.Form frmTESGastosFijosList 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   6465
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10965
   Icon            =   "frmTESGastosFijosList.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmTESGastosFijosList"
...
Private Sub cmdAccion_Click(Index As Integer)
    ...
    tabla = "gastosfijos INNER JOIN gastosfijos_recibos on gastosfijos.codigo = gastosfijos_recibos.codigo  "
    ...
    If PrimeraVez Then
        ...
        Select Case Tipo
            ...
            Case 3 ' ejercicio siguiente
                txtFecha(0).Text = Format(vParam.fechafin, "dd/mm/yyyy")
...
Private Sub frmGas_DatoSeleccionado(CadenaSeleccion As String)
    If CadenaSeleccion <> "" Then
        txtGastos(0).Text = RecuperaValor(CadenaSeleccion, 1)
        txtNGastos(0).Text = RecuperaValor(CadenaSeleccion, 2)
    End If
End Sub
...
Private Sub imgGastos_Click(Index As Integer)
    'gastos fijos
    Set frmGas = New frmBasico
    AyudaGastosFijos frmGas
    Set frmGas = Nothing
End Sub
...
Private Sub txtGastos_GotFocus(Index As Integer)
    ConseguirFoco txtGastos(Index), 3
End Sub

Private Sub txtGastos_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyAdd Then
        KeyCode = 0
        
        LanzaFormAyuda txtGastos(Index).Tag, Index
    Else
        KEYdown KeyCode
    End If
End Sub
...
Private Sub txtGastos_KeyPress(Index As Integer, KeyAscii As Integer)
    KEYpress KeyAscii
End Sub
...
Dim Hasta As Integer   'Cuando en cuenta pongo un desde, para poner el hasta
    ...
    Select Case Index
        Case 0, 1 'GASTOS
            txtNGastos(Index).Text = DevuelveDesdeBD("descripcion", "gastosfijos", "codigo", txtGastos(Index), "N")
            If txtGastos(Index).Text <> "" Then txtGastos(Index).Text = Format(txtGastos(Index).Text, "000")
    End Select
...
Dim i As Integer
    ...
    If Not PonerDesdeHasta("gastosfijos_recibos.fecha", "F", Me.txtFecha(0), Me.txtFecha(0), Me.txtFecha(1), Me.txtFecha(1), "pDHFecha=""") Then Exit Function
    If Not PonerDesdeHasta("gastosfijos.codigo", "GTO", Me.txtGastos(0), Me.txtNGastos(0), Me.txtGastos(1), Me.txtNGastos(1), "pDHGastos=""") Then Exit Function
