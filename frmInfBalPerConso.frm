...
Begin VB.Form frmInfBalPerConso 
   ...
   Begin VB.Frame frameConceptoDer 
      ...
      Begin VB.Image imgCheck 
         ...
         Index           =   1
         Left            =   4080
         Picture         =   "frmInfBalPerConso.frx":0000
      ...
      Begin VB.Image imgCheck 
         ...
         Index           =   0
         Left            =   3600
         Picture         =   "frmInfBalPerConso.frx":014A
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbFecha 
         ...
         Height          =   360
         Index           =   3
         ItemData        =   "frmInfBalPerConso.frx":0294
         Left            =   2850
         List            =   "frmInfBalPerConso.frx":0296
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   2670
         Width           =   1215
      ...
      Begin VB.ComboBox cmbFecha 
         ...
         Height          =   360
         Index           =   2
         ItemData        =   "frmInfBalPerConso.frx":0298
         Left            =   2850
         List            =   "frmInfBalPerConso.frx":029A
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   2220
         Width           =   1215
      ...
      Begin VB.ComboBox cmbFecha 
         ...
         Height          =   360
         Index           =   1
         ItemData        =   "frmInfBalPerConso.frx":029C
         Left            =   1230
         List            =   "frmInfBalPerConso.frx":029E
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   2670
         Width           =   1575
      ...
      Begin VB.ComboBox cmbFecha 
         ...
         Height          =   360
         Index           =   0
         ItemData        =   "frmInfBalPerConso.frx":02A0
         Left            =   1230
         List            =   "frmInfBalPerConso.frx":02A2
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   2220
         Width           =   1575
   ...
   End
End
Attribute VB_Name = "frmInfBalPerConso"
