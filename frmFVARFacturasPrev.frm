...
Begin VB.Form frmFVARFacturasPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   11985
   Icon            =   "frmFVARFacturasPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   13
      Tag             =   "Total Factura|N|N|||fvarfactura|totalfac|###,###,##0.00||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   12
      Tag             =   "Nombre|T|N|||fvarfactura|nommacta|||"
      Top             =   4920
      Width           =   3465
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   11
      Tag             =   "Cliente|T|N|||fvarfactura|codmacta|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   1
      Tag             =   "Factura|N|N|||fvarfactura|numfactu|0000000|S|"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Nº Serie|T|N|||fvarfactura|numserie||S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFVARFacturasPrev.frx":000C
      Height          =   5295
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmFVARFacturasPrev"
...
Dim cad As String
    ...
    Me.lblIndicador.Caption = "Leyendo..."
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select numserie, numfactu, fecfactu, codmacta, nommacta, totalfac from fvarfactura where (1=1)"
...
Private Sub CargaGrid(Optional vSql As String)
    ...
    tots = "S|txtAux(0)|T|Serie|800|;S|txtAux(1)|T|Factura|1100|;S|txtAux(2)|T|Fecha|1300|;S|txtAux(3)|T|Cuenta|1400|;S|txtAux(4)|T|Nombre|4200|;S|txtAux(5)|T|Total|2200|;"
