         ...
         Begin MSComctlLib.Toolbar Toolbar1 
            ...
            BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty Button9 {66833FEA-8583-11D1-B16A-00C0F0283628} 
                  Object.ToolTipText     =   "Listado disponible por entidad"
               EndProperty
            EndProperty
         End
      End
                ...
                Case 3  ' insertar
                    ...
                    Else
                        If GenerarRemesa(0) Then
                            MsgBox "Remesa generada correctamente.", vbInformation
                            ModoInsertar = False
                            cmdCancelar_Click (0)
                            CargaList
                        End If
...
'            BotonBuscar
    ...
    Case 9
            CadenaDesdeOtroForm = ""
             If Not lw1.SelectedItem Is Nothing Then CadenaDesdeOtroForm = lw1.SelectedItem.SubItems(4)
            frmTESbancosLimiteCredi.Show vbModal
            CadenaDesdeOtroForm = ""
    End Select
End Sub
...
Dim Sql As String
    ...
    Sql = "from cobros, formapago,cuentas where codrem = " & DBSet(lw1.SelectedItem.Text, "N") & " and anyorem = " & lw1.SelectedItem.SubItems(1)
    Sql = Sql & " and cobros.codforpa = formapago.codforpa and cobros.codmacta=cuentas.codmacta"
