...
Dim Antmodo As Byte
    ...
    Text2.Text = DevuelveDesdeBD("nomconam", "inmovcon", "codconam", Text1(6).Text, "N")
    For i = 0 To 3
        ...
        Linliapu = RecuperaValor("2|9|10|11|", i + 1)
        SQL = ""
        If Text1(Linliapu).Text <> "" Then SQL = DevuelveDesdeBD("nommacta", "cuentas", "codmacta", Text1(Linliapu).Text, "T")
        Text4(i).Text = SQL
    Next
    ...
    Antmodo = Modo
    Modo = 3
    'He quitado de aqui los de arriba. Ir sacandolos de aqui
    Text1_LostFocus (7)
    Text1_LostFocus (12)
    Text1_LostFocus (21)
    Text1_LostFocus (22)
