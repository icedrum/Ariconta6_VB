...
Begin VB.Form frmTESRecepcionDocPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   11985
   Icon            =   "frmTESRecepcionDocPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   13
      Tag             =   "Importe|N|N|||talones|importe|###,###,##0.00||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   11
      Tag             =   "Fecha|F|N|||talones|fechavto|dd/mm/yyyy||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Codigo|N|N|||talones|codigo|000000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTESRecepcionDocPrev.frx":000C
      Height          =   5145
      Left            =   120
      TabIndex        =   7
      Top             =   510
   ...
   End
End
Attribute VB_Name = "frmTESRecepcionDocPrev"
...
Private Sub CargaGrid(Optional vSql As String)
    ...
    tots = "S|txtAux(0)|T|Codigo|900|;S|txtAux(1)|T|Tipo|1100|;S|txtAux(2)|T|Fecha|1300|;S|txtAux(3)|T|Fecha Vto|1400|;S|txtAux(4)|T|Nombre|4200|;S|txtAux(5)|T|Total|2100|;"
