...
Begin VB.Form frmInmoSeccion 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Inmovilizado.       SECCIONES"
   ClientHeight    =   5730
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   6915
   Icon            =   "frmInmoSeccion.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5730
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Nombre|T|N|||inmovseccion|nomsecin|||"
      Text            =   "Dato2"
      Top             =   5640
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|0||inmovseccion|codsecin|000|S|"
      Text            =   "Dat"
      Top             =   5640
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmInmoSeccion.frx":000C
      Height          =   3840
      Left            =   150
      TabIndex        =   7
      Top             =   975
   ...
   End
End
Attribute VB_Name = "frmInmoSeccion"
...
Private Const IdPrograma = 503   'el mismo que inmovilizado
...
Dim Sql As String
    ...
    '### a mano
    Sql = "Seguro que desea eliminar la seccion:"
    Sql = Sql & vbCrLf & "Código: " & adodc1.Recordset.Fields(0)
    Sql = Sql & vbCrLf & "Descripcion: " & adodc1.Recordset.Fields(1)
    If MsgBox(Sql, vbQuestion + vbYesNoCancel) = vbYes Then
    
        'Hay que eliminar
        Sql = "Delete from inmovseccion where codsecin=" & adodc1.Recordset!codsecin
        Conn.Execute Sql
        CargaGrid ""
...
Private Sub Form_Load()
    ...
    'Cadena consulta
    CadenaConsulta = "Select codsecin, nomsecin from inmovseccion"
    CargaGrid
End Sub
...
Private Function SugerirCodigoSiguiente() As String
    ...
    Sql = "Select Max(codsecin) from inmovseccion"
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case 6
                BotonVerTodos
        Case 8
               ' frminmovseccionList.Show vbModal
        Case Else
    End Select
End Sub
...
If Modo = 3 Then
    'Estamos insertando
     Datos = DevuelveDesdeBD("codsecin", "inmovseccion", "codsecin", txtAux(0).Text, "N")
     If Datos <> "" Then
...
Dim Sql As String
    SepuedeBorrar = False
    Sql = DevuelveDesdeBD("codinmov", "inmovele", "seccion", adodc1.Recordset!codsecin, "N")
    If Sql <> "" Then
        MsgBox "Existen elementos de inmovilizado pertenecientes a esta seccion", vbExclamation
        Exit Function
    End If
