VERSION 5.00
Begin VB.Form frmTESCompensaAboCliImp 
   Appearance      =   0  'Flat
   ...
   End
End
Attribute VB_Name = "frmTESCompensaAboCliImp"
...
Private Sub Form_Load()
    ...
    'Otras opciones
    Me.Caption = "Impresión de Compensaciones"
...
Dim nomDocu As String
    ...
    End If
    If optTipoSal(3).Value Then LanzaProgramaAbrirOutlook 36
...
Private Function MontaSQL() As Boolean
    ...
    cadFormula = "{compensa.codigo}=" & pCodigo
