...
Begin VB.Form frmFormaPago 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Denominación|T|N|||formapago|nomforpa|||"
      Text            =   "Dato2"
      Top             =   5640
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código |N|N|0||formapago|codforpa|000|S|"
      Text            =   "Dat"
      Top             =   5640
      Width           =   800
   End
        ...
        Else
            ...
            If DevuelveIBAN2(BuscaChekc, Cta, Cta) Then
                If Mid(CuentaCCC, 1, 4) <> BuscaChekc & Cta Then
                    cadMen = "El código de IBAN no es correcto, debería ser " & BuscaChekc & Cta & vbCrLf & vbCrLf & "¿ Continuar ?"
...
Dim cad As String
    ...
    If Not RS.EOF Then
        Toolbar1.Buttons(1).Enabled = DBLet(RS!creareliminar, "N") And (Modo = 0 Or Modo = 2) And vParam.NroAriges = 0
        Toolbar1.Buttons(2).Enabled = DBLet(RS!Modificar, "N") And (Modo = 0 Or Modo = 2) And vParam.NroAriges = 0
        Toolbar1.Buttons(3).Enabled = DBLet(RS!creareliminar, "N") And (Modo = 0 Or Modo = 2) And vParam.NroAriges = 0
