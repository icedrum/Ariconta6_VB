VERSION 5.00
Begin VB.Form frmTESCompensaAboProImp 
   Appearance      =   0  'Flat
   ...
   End
End
Attribute VB_Name = "frmTESCompensaAboProImp"
...
Private Sub Form_Load()
    ...
    'Otras opciones
    Me.Caption = "Impresión de Compensaciones Proveedor"
     
     
    If pCodigo <> "" Then
        Label3(0).Caption = "Compensación: " & pCodigo
    Else
        Label3(0).Caption = ""
    End If
...
Dim nomDocu As String
    ...
    cadNomRPT = nomDocu ' "HerCompenCli.rpt"

    ImprimeGeneral
    
    If optTipoSal(1).Value Then CopiarFicheroASalida True, txtTipoSalida(1).Text
    If optTipoSal(2).Value Then CopiarFicheroASalida False, txtTipoSalida(2).Text
    If optTipoSal(3).Value Then LanzaProgramaAbrirOutlook 47
...
Private Function MontaSQL() As Boolean
    ...
    cadFormula = "{compensapro.codigo}=" & pCodigo
