...
Private Sub Text1_LostFocus(Index As Integer)
            ...
            If Modo > 2 And Index = 4 Then
                ...
                If CStr(Valor) <> "" Then
                    ...
                    If SQL = "" Then
                        ...
                        SQL = DevuelveIBANSeparado(Text1(19).Text)
                        Text1(10).Text = SQL
    ...
    Case 28 To 30, 10, 26, 21
        If Text1(Index).Text <> "" Then
            ...
            If Not EsIBAN_Correcto(SQL) Then MsgBox "IBAN incorrecto", vbExclamation
...
Private Sub HacerBusqueda2()
    ...
    ElseIf CadB <> "" Or CadB1 <> "" Or cadFiltro <> "" Then
        If CadB1 <> "" Then
            CadenaConsulta = "select  pagos.* from "
        ...
        Else
            'En teoria CADB1 siempre sera "", pero lo he dejado(lo de arriba, por si acaso
            CadenaConsulta = "select  pagos.* from pagos "
            'CadenaConsulta = CadenaConsulta & " (tipofpago  INNER JOIN hlinapu ON hlinapu.tipforpa = tipofpago.tipoformapago ) "
            'CadenaConsulta = CadenaConsulta & " right join pagos on pagos.numserie = hlinapu.numserie and pagos.numfactu = hlinapu.numfacpr and pagos.fecfactu = hlinapu.fecfactu and pagos.numorden = hlinapu.numorden and pagos.codmacta = hlinapu.codmacta "
        End If
...
'    PonerCtasIVA
    ...
    Text1(10).Text = DevuelveIBANSeparado(Text1(19).Text)
...
Dim Tipo As Integer
   ...
   ' DevfrmCCtas = Trim(Text1(26).Text) & Trim(Text1(28).Text) & Text1(29).Text & Trim(Text1(30).Text) & Trim(Text1(21).Text)
    ...
    DevfrmCCtas = UCase(Text1(10).Text)
    ...
    If Len(DevfrmCCtas) > 0 And Len(DevfrmCCtas) < 20 Then
    ...
    If DevfrmCCtas <> "" Then
        If Not EsIBAN_Correcto(DevfrmCCtas) Then
            If Mid(DevfrmCCtas, 1, 2) = "ES" Then
                ...
                B = False
            Else
                If MsgBox("El IBAN parece incorrecto.   ¿Continuar?", vbQuestion + vbYesNoCancel) <> vbYes Then
                    B = False
                    PonleFoco Text1(10)
                End If
            End If
    ...
    If Not B Then
        ...
        Exit Function
    Else
        Text1(19).Text = Replace(UCase(Text1(10).Text), " ", "")
    End If
    ...
    Select Case Button.Index
        Case 1 'Datos Fiscales
            ...
            If Me.FrameDatosFiscales.visible Then
                If Modo = 1 Or Modo = 3 Or Modo = 4 Then PonerFoco Text1(16)
            End If
        ...
        Case 2
            ...
            Else
                frmFacturasPro.FACTURA = Text1(13).Text & "|" & Msg & "|" & Year(CDate(Text1(2).Text)) & "|"
