...
Begin VB.Form frmFacturasCli 
   ...
   Begin VB.Frame FrameDatosFiscales 
      ...
      Begin VB.TextBox Text1 
         ...
         Left            =   1320
         TabIndex        =   98
         Tag             =   "Dirección|T|S|||factcli|dirdatos|||"
         Top             =   810
         Width           =   7830
      End
      Begin VB.TextBox Text1 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         Left            =   15540
         TabIndex        =   17
         Tag             =   "Número Asiento|N|S|||factcli|numasien|00000000||"
         Text            =   "1234567890"
         Top             =   3270
         Width           =   1290
      End
      ...
      Begin VB.ComboBox Combo1 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   7
         Tag             =   "Tipo operación|N|N|||factcli|codopera|||"
         Top             =   1260
         Width           =   2250
      End
      Begin VB.ComboBox Combo1 
      ...
      Begin VB.TextBox Text1 
         ...
         Left            =   7950
         TabIndex        =   91
         Tag             =   "Año factura|N|N|||factcli|anofactu||S|"
         Text            =   "1234567890"
         Top             =   2580
         Width           =   1350
      End
      ...
      Begin VB.TextBox Text1 
         ...
         Left            =   15540
         TabIndex        =   111
         Tag             =   "Número Diario|N|S|||factcli|numdiari|00000000||"
         Text            =   "1234567890"
         Top             =   2595
         Width           =   1290
      End
...
'Public DatosADevolverBusqueda As StringCombo1(0)    'Tendra el nº de text que quiere que devuelva, empipados
...
Dim Rs As ADODB.Recordset
    ...
    If ExisteAlgunCobro(Text1(2).Text, Text1(0).Text, FecFactuAnt, True) Then
        MsgBoxA "Hay algún efecto que ya ha sido cobrado. Revise cartera de cobros.", vbExclamation
    ...
    If CargarCobrosTemporal(Text1(5).Text, Text1(1).Text, ImporteFormateado(Text1(13).Text)) Then
        ...
        Else
            ...
            If Nregs = Nregs2 Then
                CargarCobros
            Else
                MsgBoxA "No coincide el número de cobros en tesoreria. Modifíquelos en cartera.", vbExclamation
        ...
        Case 5 'LLÍNIES
            ...
            If ModoLineas = 1 Then 'INSERTAR
                ...
                If AdoAux(1).Recordset.EOF Then
                    If MsgBoxA("No se permite una factura sin líneas " & vbCrLf & vbCrLf & "¿ Desea eliminar la factura ?", vbQuestion + vbYesNo + vbDefaultButton1) = vbYes Then
                        BotonEliminar True
                        Exit Sub
                    Else
                        ModoLineas = 1
...
'    Text1(22).Text = Combo1(0).ListIndex
    ...
    If ((Text1(6).Text = "") Xor (Text1(7).Text = "")) And Combo1(2).ListIndex > 0 Then
        MsgBoxA "No hay porcentaje de rentención sin cuenta de retención", vbExclamation
        B = False
        Exit Function
    End If
    ...
    If Modo = 4 Then
        If CDate(Text1(1).Text) <> data1.Recordset!FecFactu Then
            ...
            If Year(CDate(Text1(1).Text)) <> data1.Recordset!anofactu Then
                MsgBoxA "No puede cambiar de año la factura. ", vbExclamation
                B = False
                Exit Function
            End If
        End If
    ...
    Select Case Index
        ...
        Case 21 ' codigo de pais
            If Text1(Index).Text <> "" Then
                ...
                If Text4(Index) = "" Then
                    MsgBoxA "No existe el País. Reintroduzca.", vbExclamation
                    Text1(Index).Text = ""
                    PonFoco Text1(Index)
                End If
            Else
        ...
        Else
             ...
             If ModoLineas = 1 Then
                ...
                If CInt(ComprobarCero(txtaux(7).Text)) <> CInt(ComprobarCero(IvaCuenta)) Then
                    If MsgBoxA("El código de iva es distinto del de la cuenta. " & vbCrLf & " ¿ Desea modificarlo en la cuenta ? " & vbCrLf & vbCrLf, vbQuestion + vbYesNo) = vbYes Then
                        CambiarIva = True
                    Else
                        CambiarIva = False
                    End If
...
Dim SqlLog As String
    ...
    If Me.AdoAux(1).Recordset.EOF Then
        SqlLog = SqlLog & vbCrLf & "Línea   : EOF    Vacio"
    Else
