...
Begin VB.Form frmAgentesList 
   ...
   End
End
Attribute VB_Name = "frmAgentesList"
...
Private Sub cmdAccion_Click(Index As Integer)
    ...
    If Not PonerDesdeHasta("agentes.codigo", "AGE", Me.txtAgente(0), Me.txtNAgente(0), Me.txtAgente(1), Me.txtNAgente(1), "pDH=""") Then Exit Sub
    
    If Not HayRegParaInforme("agentes", cadselect) Then Exit Sub
...
Dim cad As String, cadTipo As String 'tipo cliente
    ...
    Select Case Index
        Case 0, 1 'AgenteS
            txtNAgente(Index).Text = DevuelveDesdeBD("nombre", "agentes", "codigo", txtAgente(Index), "N")
            If txtAgente(Index).Text <> "" Then txtAgente(Index).Text = Format(txtAgente(Index).Text, "000")
    End Select
...
Dim nomDocu As String
    ...
    If optVarios(1).Value Then
        cadParam = cadParam & "pOrden={agentes.nombre}|"
    Else
        cadParam = cadParam & "pOrden={agentes.codigo}|"
    End If
    numParam = numParam + 1
