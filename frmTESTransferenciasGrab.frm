...
Begin VB.Form frmTESTransferenciasGrab 
   ...
   ClientTop       =   330
   ClientWidth     =   7860
   Icon            =   "frmTESTransferenciasGrab.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5520
   ...
   Begin VB.Frame FrameCambioRemesa 
      ...
      Begin VB.Frame FrameTipo1_2 
         ...
         Begin VB.ComboBox cmbReferencia 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "frmTESTransferenciasGrab.frx":000C
            Left            =   4980
            List            =   "frmTESTransferenciasGrab.frx":0019
         ...
         Begin VB.ComboBox cboTipoRemesa 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "frmTESTransferenciasGrab.frx":0047
            Left            =   1740
            List            =   "frmTESTransferenciasGrab.frx":0049
            Style           =   2  'Dropdown List
            TabIndex        =   12
            Top             =   480
            Width           =   3105
   ...
   End
End
Attribute VB_Name = "frmTESTransferenciasGrab"
