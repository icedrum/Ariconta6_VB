...
Dim HanHabidoModifiaciones As Boolean
        ...
        'Ha seleccionado alguna cuenta
         If Text2(2).Text <> "" Then
            If MsgBox("Falta cuadrar punteo.  Salir?", vbQuestion + vbYesNoCancel) <> vbYes Then
                ...
                Exit Sub
            End If
            HanHabidoModifiaciones = False
        End If
    End If
    
    If HanHabidoModifiaciones Then
        If MsgBox("Desea cerrar ?", vbQuestion + vbYesNoCancel) <> vbYes Then
            Cancel = 1
            Exit Sub
        End If
    End If
